...
export class Koge extends ethereum.SmartContract {
  static bind(address: Address): Koge {
    return new Koge("Koge", address);
  }
...
export class ReflectCall extends ethereum.Call {
  get inputs(): ReflectCall__Inputs {
    return new ReflectCall__Inputs(this);
  }

  get outputs(): ReflectCall__Outputs {
    return new ReflectCall__Outputs(this);
  }
}

export class ReflectCall__Inputs {
  _call: ReflectCall;

  constructor(call: ReflectCall) {
    this._call = call;
  }
...
export class ReflectCall__Outputs {
  _call: ReflectCall;
...
export class SetFeeFracCall extends ethereum.Call {
  get inputs(): SetFeeFracCall__Inputs {
    return new SetFeeFracCall__Inputs(this);
  }

  get outputs(): SetFeeFracCall__Outputs {
    return new SetFeeFracCall__Outputs(this);
  }
}

export class SetFeeFracCall__Inputs {
  _call: SetFeeFracCall;

  constructor(call: SetFeeFracCall) {
    this._call = call;
  }
...
export class SetFeeFracCall__Outputs {
  _call: SetFeeFracCall;
